...
#ifdef CONFIG_LIBPMEM2_INSTALLED
	/* libpmem2 persist function from pmem2_map */
	pmem2_persist_fn persist;
#endif
};

#ifdef CONFIG_LIBPMEM2_INSTALLED
static int server_init(struct thread_data *td, struct librpma_fio_mem *mem)
#else
...
#endif
{
	...
	sd->persist = pmem2_get_persist_fn(mem->map);
#endif
